...
//      throws Exception {
//	  System.out.println("Inside register: Object - " + signUpRequest);
//	  
//    Optional<User> user = myUserDetailsService.getUserByUsername(signUpRequest.getUsername());
//    System.out.println("User data: " + user.get().toString() + " " + user.isEmpty());
//    if (!user.isPresent()) {
//    	System.out.println("User not found, inside if");
...
//      System.out.println("Added user val: " + addedUser);
